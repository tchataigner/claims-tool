...
interface ERC735 {
    ...
    function changeClaim(bytes32 _claimId, bytes32 _topic, uint256 _scheme, address _issuer, bytes calldata _signature, bytes calldata _data, string calldata _uri) external returns (bool success);
